import{S as u}from"./storybook-BJU81olc.js";import{T as C,I as s}from"./enum-D-JvIl_F.js";import{I as q}from"./Input-o93AMGmi.js";import"./vue.esm-bundler-BR4_nak_.js";import"./Icon-DaKYYYyB.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./Button-CkelqJH3.js";import"./sizes-9jYRAigb.js";const J={title:"Input/Input",component:q,argTypes:{class:{control:{type:u.select},options:s},required:{control:{type:u.boolean},defaultValue:!1}},args:{placeholder:"Введите текст",type:C.text,inputMessage:"Текст"},tags:["autodocs"]},n=w=>({components:{Input:q},setup(){return{args:w}},template:`<Input v-bind="args" :disabled="args.class === 'disabled'" />`}),r=n.bind({});r.args={class:s.initial};const a=n.bind({});a.args={class:s.disabled};const e=n.bind({});e.args={class:s.error};const t=n.bind({});t.args={class:s.warning};const o=n.bind({});o.args={class:s.success};const p=n.bind({});p.args={class:s.ordinary};const c=n.bind({});c.args={class:s.minor};var d,i,l;r.parameters={...r.parameters,docs:{...(d=r.parameters)==null?void 0:d.docs,source:{originalSource:`args => ({
  components: {
    Input
  },
  setup() {
