import{B as d,a as t}from"./Button-BcbnAUXm.js";import{I as K,a as L}from"./Icon-BRmBMtLe.js";import{S as M}from"./sizes-9jYRAigb.js";import{C as Q}from"./colors-BMxzW9Sg.js";import{S as e}from"./storybook-BJU81olc.js";import{f as U}from"./index-CGbn3E6N.js";import"./vue.esm-bundler-DC1UwcWE.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const rt={title:"Button/Button",component:d,argTypes:{disabled:{control:{type:e.boolean},defaultValue:!1},pill:{control:{type:e.boolean},defaultValue:!1},size:{control:{type:e.radio},options:M},type:{control:{type:e.select},options:t},content:{control:{type:e.text},description:"Кастомный контент кнопки",defaultValue:{summary:"Button"}},iconName:{control:{type:e.select},description:"Имя иконки",options:K},iconPosition:{control:{type:e.radio},options:["left","right"],description:"Позиция иконки",defaultValue:"left"},iconColor:{control:{type:e.select},description:"Цвет иконки",options:Q}},tags:["autodocs"],args:{onClick:U()}},o=u=>({components:{Button:d,Icon:L},setup(){return{args:u}},template:`
