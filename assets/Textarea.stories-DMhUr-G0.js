import{l as U,d as A,k as J,w as K,n as p,E as Q,s as R,q as f,G as X,H as Y,z as Z,p as ee,m as c}from"./vue.esm-bundler-CrrBMa2I.js";import{_ as ae}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{I as t}from"./enum-D-JvIl_F.js";import{S as x}from"./storybook-BJU81olc.js";var N=(a=>(a.default="default",a.minor="minor",a))(N||{});const se=["data-testid"],te=["data-testid"],re=["data-testid"],ne=["data-testid","placeholder","required","maxlength","readonly"],F=U({__name:"Textarea",props:{placeholder:{},inputMessage:{},required:{type:Boolean,default:!1},maxlength:{},modelValue:{default:""},readonly:{type:Boolean,default:!1},type:{default:N.default},modelModifiers:{default:()=>({})},dataTestid:{default:"Textarea"}},emits:["update:modelValue"],setup(a,{emit:$}){const e=a,z=$,s=A({isPressed:!1,inputElement:e.modelValue}),L=J(()=>[{pressed:s.isPressed,readonly:e.readonly,[e.type]:!0}]),W=()=>{z("update:modelValue",s.inputElement)},j=()=>{e.readonly||(s.isPressed=!0)},G=()=>{s.isPressed=!1};return K(()=>e.modelValue,m=>{s.inputElement=m}),(m,g)=>(c(),p("fieldset",{class:ee(["input-yui-kit",L.value]),onFocusout:G,"data-testid":e.dataTestid},[e.inputMessage?(c(),p("legend",{key:0,class:"input-yui-kit__legend","data-testid":`${e.dataTestid}-Legend`},[Q(R(e.inputMessage)+" ",1),e.required?(c(),p("sup",{key:0,class:"input-yui-kit__star","data-testid":`${e.dataTestid}-Legend-Star`},"*",8,re)):f("",!0)],8,te)):f("",!0),X(Z("textarea",{"onUpdate:modelValue":g[0]||(g[0]=H=>s.inputElement=H),onFocus:j,onInput:W,"data-testid":`${e.dataTestid}-Textarea`,class:"input-yui-kit__input",placeholder:e.placeholder,required:e.required,maxlength:e.maxlength,readonly:e.readonly},null,40,ne),[[Y,s.inputElement]])],42,se))}}),O=ae(F,[["__scopeId","data-v-d71a57d3"]]);F.__docgenInfo={exportName:"default",displayName:"Textarea",description:"",tags:{},props:[{name:"dataTestid",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'Textarea'"}},{name:"placeholder",required:!1,type:{name:"string"}},{name:"inputMessage",required:!1,type:{name:"string"}},{name:"required",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"maxlength",required:!1,type:{name:"number"}},{name:"modelValue",required:!0,type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"readonly",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"type",required:!1,type:{name:"TextareaTypeEnum"},defaultValue:{func:!1,value:"TextareaTypeEnum.default"}},{name:"modelModifiers",required:!0,type:{name:"object"},defaultValue:{func:!1,value:"() => ({})"}}],events:[{name:"update:modelValue",type:{names:["string"]}}],sourceFiles:["/home/runner/work/sep_yui/sep_yui/src/components/Textarea/Textarea.vue"]};const ie={title:"Textarea/Textarea",component:O,argTypes:{class:{control:{type:x.select},options:t},required:{control:{type:x.boolean},defaultValue:!1}},args:{placeholder:"Введите текст",inputMessage:"Текст"},tags:["autodocs"]},r=a=>({components:{Textarea:O},setup(){return{args:a}},template:`
  ...
  template: \`
      <Textarea v-bind="args" :disabled="args.class === 'disabled'" />
  \`
})`,...(B=(M=u.parameters)==null?void 0:M.docs)==null?void 0:B.source}}};var D,w,C;i.parameters={...i.parameters,docs:{...(D=i.parameters)==null?void 0:D.docs,source:{originalSource:`(args: ITextareaProps) => ({
  components: {
    Textarea
  },
  setup() {
