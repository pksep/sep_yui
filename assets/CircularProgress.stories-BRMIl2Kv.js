import{j as m,k as n,l as c,D as s,E as l}from"./vue.esm-bundler-CCGp2uGQ.js";import{_ as C}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{S as _}from"./storybook-BJU81olc.js";import{f as y}from"./index-CGbn3E6N.js";const h=["data-testid"],P=["data-testid"],v=["data-testid"],x=["data-testid"],u=m({__name:"CircularProgress",props:{percent:{},dataTestid:{default:"CircularProgress"}},setup(o){const r=o,f=()=>{const t=Math.min(Math.max(r.percent,0),100),e=t/100*360;if(t<=25)return`polygon(50% 50%, 50% 0%, calc(50% + 50% * cos(${e-90}deg)) 0,calc(50% + 50% * cos(${e-90}deg)) calc(50% + 50% * sin(${e-90}deg)), 50% 50%)`;if(t<=50)return`polygon(50% 50%, 50% 0%, 100% 0%, 100% calc(50% + 50% * sin(${e-90}deg)), calc(50% + 50% * cos(${e-90}deg)) calc(50% + 50% * sin(${e-90}deg)), 50% 50%)`;if(t<=75)return`polygon(50% 50%, 50% 0%, 100% 0%, 100% 100%,
